...
export type { SecretVault } from "./contracts/secrevault.sol/SecretVault";
export { SecretVault__factory } from "./factories/contracts/secrevault.sol/SecretVault__factory";
